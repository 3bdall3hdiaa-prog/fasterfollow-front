            ...
            <div className="space-y-6">
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-400">غير مفعلة. قم بتفعيلها لزيادة أمان حسابك.</p>
                    </div>
                    <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg text-sm">تفعيل</button>
                </div>
            </div>
        );
    };
